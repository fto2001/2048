    ...
    initialize() {
        ...
        document.addEventListener('keyup', (e) => {
            ...
            if (['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'].includes(key)) {
                this.moveTiles(key.substring(5).toLowerCase());
                this.saveGameState();
            }
        });
            ...
            for (let secondary = 0; secondary < this.columns; secondary++) {
                ...
                if (this.board[row][column] !== 0) {
                    ...
                    while (true) {
                        ...
                        let nextRow = newRow + verticalMove;
                        let nextColumn = newColumn + horizontalMove;
...
const tileGame = new TileGame(4, 4);

window.onload = function() {
    tileGame.loadGameState();
    tileGame.updateBoard();
    tileGame.setRandomTileToBoard();
    tileGame.setRandomTileToBoard();
    tileGame.askToRestoreProgress();
};
